...
| 組員   | 系級     | 學號      | 工作分配                       |
|--------|----------|-----------|--------------------------------|
| 陳紹瑜 | 資科碩一 | 113753212 | 組長、前端開發、後端開發、README 整理           |
| 陳凱輝 | 資科碩一 | 113753120 | 前端開發、後端開發、Demo 報告、題目說明、系統功能與模組架構             |
| 錡軒誼 | 資科碩一 | 113753118 | 前端開發、後端開發、建立及部署雲端資料庫         |
| 林佩昀 | 應數碩二 | 111751002 | ER model、Relational Schema、後端開發、部署 API 至雲端          |
| 余嘉恆 | 應數碩二 | 112751004 |                        |
